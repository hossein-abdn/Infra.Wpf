...
namespace DataAccess.Mappings
{
    ...
    public class PlaceMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Place>
    {
        public PlaceMap()
            : this("dbo")
        {
        ...
        public PlaceMap(string schema)
        {
            ...
            Property(x => x.PlaceId).HasColumnName(@"PlaceId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.Name).HasColumnName(@"Name").HasColumnType("nvarchar").IsRequired().HasMaxLength(30);
            Property(x => x.PlaceTypeId).HasColumnName(@"PlaceTypeId").HasColumnType("int").IsRequired();
            Property(x => x.TermId).HasColumnName(@"TermId").HasColumnType("int").IsOptional();
            Property(x => x.PlaceGroupId).HasColumnName(@"PlaceGroupId").HasColumnType("int").IsRequired();
