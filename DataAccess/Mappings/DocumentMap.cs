...
namespace DataAccess.Mappings
{
    ...
    public class DocumentMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Document>
    {
        public DocumentMap()
            : this("dbo")
        {
        ...
        public DocumentMap(string schema)
        {
            ...
            Property(x => x.RootId).HasColumnName(@"RootId").HasColumnType("int").IsRequired();
            ...
            Property(x => x.ExtensionTypeId).HasColumnName(@"ExtensionTypeId").HasColumnType("int").IsRequired();
            ...
            Property(x => x.Path).HasColumnName(@"Path").HasColumnType("nvarchar(max)").IsRequired();
            Property(x => x.SaveSourcePath).HasColumnName(@"SaveSourcePath").HasColumnType("nvarchar").IsOptional().HasMaxLength(100);
