...
namespace DataAccess.Mappings
{
    ...
    public class QuestionItemMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<QuestionItem>
    {
        ...
        public QuestionItemMap(string schema)
        {
            ...
            HasKey(x => x.QuestionItemId);

            Property(x => x.QuestionItemId).HasColumnName(@"QuestionItemId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.QuestionId).HasColumnName(@"QuestionId").HasColumnType("int").IsRequired();
            Property(x => x.Turn).HasColumnName(@"Turn").HasColumnType("int").IsRequired();
            Property(x => x.QuestionTypeId).HasColumnName(@"QuestionTypeId").HasColumnType("int").IsRequired();
            Property(x => x.Text).HasColumnName(@"Text").HasColumnType("nvarchar").IsOptional().HasMaxLength(100);
